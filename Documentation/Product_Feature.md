...
This document provides a high-level overview of the core features of the NeuroDesk platform. For a complete strategic overview, please see the [Product Blueprint](Product_Blueprint.md).
